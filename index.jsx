...
const galleryProjects = [
  {
    ...
    description: "Arco dourado com balões perolados para cerimônia nupcial",
    aspect: "tall",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    category: "Arranjos de Balões",
    description: "Coluna de balões em preto e dourado para lançamento de produto",
    aspect: "square",
  },
  {
    id: 4,
    ...
    category: "Buffet & Decoração",
    description: "Ambientação completa para debutante com balões e buffet exclusivo",
    aspect: "tall",
  },
  {
    id: 5,
    ...
    category: "Buffet",
    description: "Buffet completo para 200 convidados com decoração temática",
    aspect: "wide",
  },
  {
    id: 6,
    title: "Bodas de Ouro",
    category: "Arranjos de Balões",
    description: "Decoração sofisticada com balões dourados e brancos",
    aspect: "square",
  },
  {
    id: 7,
    ...
    category: "Buffet & Decoração",
    description: "Mesa de bolo e arranjos delicados para recepção de bebê",
    aspect: "wide",
  },
  {
    id: 8,
    title: "Formatura Executiva",
    category: "Arranjos de Balões",
    description: "Arco de entrada e painéis de balões para festa de formatura",
    aspect: "tall",
  },
];
...
const portfolioProjects = [
  ...
  {
    id: 10,
    title: "Noivado Íntimo",
    category: "Buffet & Decoração",
    description: "Mesa de frios e champagne com arranjos florais e balões",
    aspect: "tall",
  },
  {
    id: 11,
    title: "Revelação de Gênero",
    category: "Arranjos de Balões",
    description: "Canhão de balões e decoração para revelação especial",
    aspect: "wide",
  },
  {
    id: 12,
  ...
  },
  {
    ...
    category: "Buffet & Decoração",
    description: "Mesversário luxuoso com smash cake e buffet para família",
    aspect: "square",
  },
  {
    id: 14,
    ...
    category: "Arranjos de Balões",
    description: "Passarela decorada com balões orgânicos ao estilo jardim",
    aspect: "tall",
  },
  {
    id: 15,
    title: "Festa Temática Adulto",
    category: "Buffet & Decoração",
    description: "Tema anos 80 com buffet e decoração retrô exclusiva",
    aspect: "wide",
  },
  {
    id: 16,
    title: "Inauguração Comercial",
    category: "Arranjos de Balões",
    description: "Decoração de fachada e interior para abertura de loja",
    aspect: "square",
  },
];
    ...
    <div style={{ background: BLACK, minHeight: "100vh", paddingTop: "8rem" }}>
      ...
      <div style={{
        ...
        <p style={{
          ...
          Uma selecao dos nossos projetos mais memoraveis
        </p>
      </div>
